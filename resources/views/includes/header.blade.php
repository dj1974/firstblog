        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li @if(Request::is('project')) class="active" @endif><a href="{{route('project')}}">Projects</a></li>
                    <li @if(Request::is('service')) class="active" @endif><a href="{{route('service')}}">Services</a></li>
                    </li>
                    @if(Auth::check())
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {{--@endif--}}
                    @if(Auth::check())
                        <li @if(Request::is('account')) class="active" @endif><a  href="{{route('account')}}" ><i class="fa fa-user"
                                                                                      aria-hidden="true"></i>
                                Account</a></li>
                        ...
                        <li class="dropdown">
                            <a class="btn btn-toolbar dropdown-toggle"
                               data-toggle="dropdown">Logged as : {{Auth::user()->first_name}} {{ Auth::user()->last_name}}
                    ...
                    @else
                        <li @if(Request::is('register')) class="active" @endif><a  href="{{route('register')}}" ><i class="fa fa-users"
                                                                                       aria-hidden="true"></i>
                                Register</a></li>
                        <li @if(Request::is('login')) class="active" @endif ><a href="{{route('login')}}" ><i class="fa fa-sign-in"
                                                                                    aria-hidden="true"></i>
                                Login</a></li>
                    @endif
                </ul>
